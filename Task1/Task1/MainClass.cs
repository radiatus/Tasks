...
namespace Task1
{
    class MainClass
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\nВведите значения a, b, c для уравнения ax + by = c");
            ...
            Console.WriteLine("\nВведите значения d, e, f для уравнения dx + ey = f");
            ...
            Console.WriteLine("\nРешением системы уравнений являются x = {0} и y = {1}", (c * e - b * f) / delta, (a * f - c * d) / delta);
