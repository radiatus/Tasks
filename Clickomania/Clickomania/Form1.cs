...
namespace clickmania
{
    public partial class Form1 : Form
    {
        ...
        public void CreateField(Cubs[,] cubs, int rows, int columns, int colCount)//геним поле
        {
            for (int i = 0; i < rows; i++)
                for (int j = 0; j < columns; j++)
                {
                    ...
                    elem.drawCub(g, col[elem.Colour], elem.x, elem.y, Pens.Black);//рисуем этот кубик
                    cubs[i,j] = elem;//пихаем кубик в массив поля для дальнейшего юзанья
                }
        }

        //private void Nieghbor(int rowClick, int columnClick) // прикол с отрисовкой при выходи из рекурсии надо сделать
        //{
        //    if(rowClick > 0)
        //        if (newgame.FieldCubs[rowClick - 1, columnClick].Colour == newgame.FieldCubs[rowClick, columnClick].Colour && newgame.FieldCubs[rowClick - 1, columnClick].Deleted == false)
        //    {
        //           // if(newgame.FieldCubs[rowClick, columnClick].Deleted == false)
        //                newgame.FieldCubs[rowClick, columnClick].drawCub(g, Brushes.LightGray, newgame.FieldCubs[rowClick, columnClick].x, newgame.FieldCubs[rowClick, columnClick].y, Pens.LightGray);
        //        newgame.FieldCubs[rowClick, columnClick].Deleted = true;
        //            indexs++;
        //        Nieghbor(rowClick - 1, columnClick);
        //    }
        //    if(rowClick < newgame.FieldCubs.GetLength(0) - 1)
        //        if (newgame.FieldCubs[rowClick + 1, columnClick].Colour == newgame.FieldCubs[rowClick, columnClick].Colour && newgame.FieldCubs[rowClick+1, columnClick].Deleted == false)
        //    {
        //           // if (newgame.FieldCubs[rowClick, columnClick].Deleted == false)
        //                newgame.FieldCubs[rowClick, columnClick].drawCub(g, Brushes.LightGray, newgame.FieldCubs[rowClick, columnClick].x, newgame.FieldCubs[rowClick, columnClick].y, Pens.LightGray);
        ...
        //    }
        //    if (columnClick > 0)
        //        if (newgame.FieldCubs[rowClick, columnClick - 1].Colour == newgame.FieldCubs[rowClick, columnClick].Colour && newgame.FieldCubs[rowClick, columnClick-1].Deleted == false)
        //    {
        //            //if (newgame.FieldCubs[rowClick, columnClick].Deleted == false)
        //                newgame.FieldCubs[rowClick, columnClick].drawCub(g, Brushes.LightGray, newgame.FieldCubs[rowClick, columnClick].x, newgame.FieldCubs[rowClick, columnClick].y, Pens.LightGray);
        //        newgame.FieldCubs[rowClick, columnClick].Deleted = true;
        ...
        //    }
        //    if (columnClick < newgame.FieldCubs.GetLength(1) - 1)
        //        if (newgame.FieldCubs[rowClick, columnClick + 1].Colour == newgame.FieldCubs[rowClick, columnClick].Colour && newgame.FieldCubs[rowClick, columnClick+1].Deleted == false)
        //    {
        //           // if (newgame.FieldCubs[rowClick, columnClick].Deleted == false)
        //                newgame.FieldCubs[rowClick, columnClick].drawCub(g, Brushes.LightGray, newgame.FieldCubs[rowClick, columnClick].x, newgame.FieldCubs[rowClick, columnClick].y, Pens.LightGray);
        ...
        private void panel2_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            //Nieghbor(newgame.rowIndex, newgame.colIndex);
        }
        ...
        private void panelGame_Paint(object sender, PaintEventArgs e)
        {
            ...
            Color[] colors = new Color[] { Color.Red, Color.Green, Color.Blue, Color.Red, Color.Green, Color.Blue, Color.Red, Color.Green, Color.Blue };
            for (int y = 0; y < newgame.RowsCount; y++)
                for (int x = 0; x < newgame.ColumnsCount; x++) {
                    Brush b = new SolidBrush(colors[newgame[y, x]]);
                    e.Graphics.FillEllipse(b, x * 30, y * 30, 30, 30);
                }
        }
    }
}
